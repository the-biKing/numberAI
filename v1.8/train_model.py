...
def forward_pass(X, H1_mat, H1_1_mat, H1_2_mat, H1_3_mat, H1_4_mat, H1_5_mat, H1_6_mat, H2_mat):
    N = X.shape[0]
    ...
    A = np.dot(M1, H2_mat)
    return O_H1, O1_1, O1_2, O1_3, O1_4, O1_5, O1_6, M1, A
...
def save_model(H1_mat, H1_1_mat, H1_2_mat, H1_3_mat, H1_4_mat, H1_5_mat, H1_6_mat, H2_mat):
...
try:
    for epoch in range(epochs):
        ...
        for i in range(0, num_train, batch_size):
            ...
            # 1. Forward Pass
            O_H1, O1_1, O1_2, O1_3, O1_4, O1_5, O1_6, M1, A = forward_pass(X_batch, H1, H1_1, H1_2, H1_3, H1_4, H1_5, H1_6, H2)
            ...
            dO1_5_flat = hidden_error_pre_relu[:, 56:84]
            dO1_2_flat = hidden_error_pre_relu[:, 84:112]
            dO1_3_flat = hidden_error_pre_relu[:, 112:140]
            dO1_6_flat = hidden_error_pre_relu[:, 140:168]
            dO1_4_flat = hidden_error_pre_relu[:, 168:196]
            ...
            X1_1 = X_2d[:, 0:7, :]
            dH1_1 = np.tensordot(X1_1, dO1_1, axes=([0, 1], [0, 1]))
            
            X1_2 = X_2d[:, 7:14, :]
            dH1_2 = np.tensordot(X1_2, dO1_2, axes=([0, 1], [0, 1]))
            
            X1_3 = X_2d[:, 14:21, :]
            dH1_3 = np.tensordot(X1_3, dO1_3, axes=([0, 1], [0, 1]))
            
            X1_4 = X_2d[:, 21:28, :]
            dH1_4 = np.tensordot(X1_4, dO1_4, axes=([0, 1], [0, 1]))
            
            X1_5 = X_2d[:, 0:14, 7:21]
            dH1_5 = np.tensordot(X1_5, dO1_5, axes=([0, 1], [0, 1]))
            
            X1_6 = X_2d[:, 14:28, 7:21]
            dH1_6 = np.tensordot(X1_6, dO1_6, axes=([0, 1], [0, 1]))
            ...
            if np.isnan(np.sum(H2)):
                ...
                save_model(best_H1, best_H1_1, best_H1_2, best_H1_3, best_H1_4, best_H1_5, best_H1_6, best_H2)
                raise StopIteration
                
        # Calculate full train metrics for epoch logging
        _, _, _, _, _, _, _, _, train_A = forward_pass(x_train, H1, H1_1, H1_2, H1_3, H1_4, H1_5, H1_6, H2)
        train_loss, train_acc = get_metrics(train_A, y_train)
        
        _, _, _, _, _, _, _, _, test_A = forward_pass(x_test, H1, H1_1, H1_2, H1_3, H1_4, H1_5, H1_6, H2)
...
_, _, _, _, _, _, _, _, test_A = forward_pass(x_test, best_H1, best_H1_1, best_H1_2, best_H1_3, best_H1_4, best_H1_5, best_H1_6, best_H2)

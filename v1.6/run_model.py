...
def run_inference(image_path, H1_1, H1_2, H1_3, H1_4, H2, quiet=False):
...
if __name__ == "__main__":
    ...
    total_params = H1_1.size + H1_2.size + H1_3.size + H1_4.size + H2.size
    total_size_kb = (H1_1.nbytes + H1_2.nbytes + H1_3.nbytes + H1_4.nbytes + H2.nbytes) / 1024.0
    ...
    if len(sys.argv) > 1:
        ...
        run_inference(sys.argv[1], H1_1, H1_2, H1_3, H1_4, H2, quiet=False)
        ...
        def evaluate_directory(directory, dataset_name):
            ...
            for filename in os.listdir(directory):
                if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp')):
                    ...
                    predicted = run_inference(img_path, H1_1, H1_2, H1_3, H1_4, H2, quiet=True)
